...
export default function Intro() {
  ...
  const [hideComponent, setComponent] = useState(false);
  ...
  return (
    <div className={hideComponent ? "handwriting-hide" : "handwriting"}>
      <svg
        className={
          isVisible
            ? "mask"
            : "mask animate__animated animate__fadeOut animate__delay-3s"
        }
